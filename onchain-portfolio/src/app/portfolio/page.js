          ...
          <Card className="glass md:sticky md:top-20 md:h-fit">
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                <img
                  src="https://avatars.githubusercontent.com/u/108346949?v=4"
                  alt="Bhopal Dao"
                ...
                Beginner in cybersecurity and IT
                </p>
                <div className="flex space-x-4 mb-4">
                  <a
                    href="https://x.com/rounak131106"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/in/rounak-premchandani-4220b024a/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button
